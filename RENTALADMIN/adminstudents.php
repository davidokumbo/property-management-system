    ...
    <table>
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $date?></td>
                    <td class="edit">
                        <a href="editstudent.php?email=<?php echo $email?>">EDIT</a>
                    </td>
                    <td class="status">
                        <?php
                    if($status=='0'){
                       echo"<a href='blockstudents.php?username=$username&status=1'>BLOCK</a>";
                    }elseif($status=='1'){
                        $userstatus='UNBLOCK';
                        echo"<a href='blockstudents.php?username=$username&status=0'>UNBLOCK</a>";
                    }
