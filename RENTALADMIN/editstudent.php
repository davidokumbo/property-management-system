                    ...
                    if ($countnum != 10) {
                     ...
                     $sqlupdate="UPDATE userdetails SET
                      ...
                      if($sqlupdatequerry==true){
                        $_SESSION['studentupdate']='Records for landlord '.$name.' updated successfully';
